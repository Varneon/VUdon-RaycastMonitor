...
# [VUdon](https://github.com/Varneon/VUdon) - Raycast Monitor [![GitHub Repo stars](https://img.shields.io/github/stars/Varneon/VUdon-RaycastMonitor?style=flat&label=Stars)](https://github.com/Varneon/VUdon-RaycastMonitor/stargazers) [![GitHub all releases](https://img.shields.io/github/downloads/Varneon/VUdon-RaycastMonitor/total?color=blue&label=Downloads&style=flat)](https://github.com/Varneon/VUdon-RaycastMonitor/releases) [![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/Varneon/VUdon-RaycastMonitor?color=blue&label=Release&sort=semver&style=flat)](https://github.com/Varneon/VUdon-RaycastMonitor/releases/latest)

</div>

Runtime tool for inspecting worlds in VRChat with a customizable raycast
